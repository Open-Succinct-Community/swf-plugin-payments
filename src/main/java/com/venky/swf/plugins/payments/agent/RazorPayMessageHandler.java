package com.venky.swf.plugins.payments.agent;
...
public class RazorPayMessageHandler implements Task {
    ...
    private Purchase getPurchase(JSONObject payload) {
        ...
        paymentIdWhere.add(new Expression(ref.getPool(),"RAZORPAY_PAYMENT_ID", Operator.EQ, paymentId));
        paymentIdWhere.add(new Expression(ref.getPool(),"RAZORPAY_PAYMENT_ID", Operator.EQ));
